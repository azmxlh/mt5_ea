//+------------------------------------------------------------------+
//| TrendNanpinEA.mq5 - 繝医Ξ繝ｳ繝会ｼ九リ繝ｳ繝斐Φ EA                          |
//| 繝代ち繝ｼ繝ｳA縲廛 隍・焚蜷梧凾遞ｼ蜒榊ｯｾ蠢懃沿・磯壼ｸｸ蜿｣蠎ｧ迚茨ｼ・                      |
//+------------------------------------------------------------------+
...
// 繝代ち繝ｼ繝ｳ蛻･繧ｷ繝ｳ繝懊Ν螳夂ｾｩ・磯壼ｸｸ蜿｣蠎ｧ・・
const string g_patternSymbols[PATTERN_COUNT][PAIR_COUNT] = {
   {"USDJPY", "GBPJPY", "AUDJPY", "EURAUD"},  // A: 蜀・｣ｲ繧・繝ｦ繝ｼ繝ｭ螢ｲ繧・
   {"NZDJPY", "CADJPY", "CHFJPY", "GBPAUD"},  // B: 蜀・｣ｲ繧雁挨繝壹い+繝昴Φ繝芽ｲｷ縺・
   {"EURUSD", "GBPUSD", "AUDUSD", "USDCHF"},  // C: 繝峨Ν雋ｷ縺・ｸｭ蠢・
   {"EURJPY", "USDJPY", "GBPCHF", "AUDNZD"}   // D: 鬮倬≡蛻ｩ騾夊ｲｨ雋ｷ縺・
};
